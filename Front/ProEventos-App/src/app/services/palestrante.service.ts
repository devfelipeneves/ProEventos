...
export class PalestranteService {
  ...
  public salvarPalestrante(metodo: string, palestrante?: Palestrante, ): Observable<Palestrante>{
    return (metodo === 'postPalestrante')
    ? this.postPalestrante()
    : this.putPalestrante(palestrante!);
  }
}
